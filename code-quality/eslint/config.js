    ...
    rules: {
        ...
        'lines-around-comment': [
            'warn',
            {
                ...
                allowClassEnd: true,
                ignorePattern: `(${WARNING_COMMENTS.join('|')}|${WARNING_COMMENTS.join('|').toUpperCase()}|noinspection)`,
            },
        ],
        ...
        'max-len': [
            ...
            {
                code: 120,
                ignorePattern: `(import\\s+.+from\\s+|(?:const|var)\\s+.+=\\s*require\\([^)]+\\)|(?:\\/\\/|\\/\\*)\\s*eslint-|(?:\\/\\/|\\/\\*)\\s*(?:${WARNING_COMMENTS.join('|')}|${WARNING_COMMENTS.join('|').toUpperCase()}))`,
