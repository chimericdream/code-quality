...
module.exports = {
    ...
    rules: {
        ...
        'generator-star-spacing': ['warn', {after: false, before: true, anonymous: {before: false, after: true}}],
        ...
        'key-spacing': ['warn', {afterColon: true, beforeColon: false, mode: 'minimum'}],
        ...
        'object-curly-newline': ['warn', {minProperties: 4, multiline: true, consistent: true}],
        ...
        'quotes': [
            'warn', 'single', {allowTemplateLiterals: true, avoidEscape: true},
        ],
